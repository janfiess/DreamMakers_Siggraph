namespace VRTK.Examples
{
    ...
    public class Openable_Door : VRTK_InteractableObject
    {
        ...
        private float doorOpenAngle = -160;
        ...
        {
            openRotation = new Vector3(defaultRotation.x, defaultRotation.y , defaultRotation.z + (doorOpenAngle * (sideFlip * side)));
        }
